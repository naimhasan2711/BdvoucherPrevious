...
public class SeachPayLoad {
    ...
    public SeachPayLoad(int id, String productTitle, int companyId, String productDetails, String offerDetails, String offerStartTime, String offerEndTime, int brandId, int unitPrice, String productCode, String companyName, int imageCount) {
        Id = id;
