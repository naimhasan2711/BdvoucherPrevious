...
public class HomeBlockSingleIteam {
    int Id;
    String ProductTitle;
    int CompanyId;
    ...
    public HomeBlockSingleIteam(int id, String productTitle, int companyId, String productDetails, String offerDetails, String offerStartTime, String offerEndTime, int brandId, int unitPrice, String productCode, String companyName, int imageCount, String offerDiscount, String promotionalUrl, String offerAddress) {
        Id = id;
